            ...
            <div className="max-w-md w-full space-y-8">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Sign in with your NIS or email address
                    </p>
                </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="border-t border-gray-200 pt-4">
                            ...
                            <div className="grid grid-cols-1 gap-2">
                                <Link
                                    to="/login-parent"
                                    className="w-full text-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                                >
                                    Login as Parent
                                </Link>
                                <Link
