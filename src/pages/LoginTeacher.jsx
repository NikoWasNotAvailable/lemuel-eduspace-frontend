                    ...
                    <div className="space-y-4">
                        ...
                        <div className="border-t border-gray-200 pt-4">
                            ...
                            <div className="grid grid-cols-1 gap-2">
                                <Link
                                    to="/login"
                                    className="w-full text-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
                                >
                                    Login as Student
                                </Link>
                                <Link
